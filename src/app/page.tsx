  ...
  return (
    <div className="min-h-screen bg-black text-white relative font-sans adaptive-scale-wrapper">
      ...
      <div className="relative w-full" style={HOME_TRACK_HEIGHT_STYLE}>
        ...
        <div className="w-full h-[102vh] md:h-[100dvh] sticky top-0 z-10 pointer-events-none">
          <div className="absolute inset-0 pointer-events-auto">
            <section
              id="home"
              ref={homeSectionRef}
              className="w-full h-full min-h-[102vh] md:min-h-[100dvh] flex flex-col justify-start md:justify-center overflow-hidden pt-16 md:pt-20"
